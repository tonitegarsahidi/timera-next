...
import { Clock, ChevronLeft, ChevronRight, Timer, Settings, Calendar } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-4 flex flex-col gap-4">
        {/* 2. Slide gambar dalam ukuran besar */}
        ...
        {/* 3. Waktu Sekarang dan Countdown dalam satu baris */}
          ...
          {nextPrayer && (
            ...
            >
              <CardContent className="p-6 flex flex-col items-center backdrop-blur-sm bg-background/30">
                ...
                <span className="text-5xl font-bold tabular-nums">{formatTimeUntil(countdown)}</span>
                <span className="text-sm text-muted-foreground mt-2">
                  Waktu {nextPrayer.indonesianName}: {formatTime(nextPrayer.time)}
                </span>
              </CardContent>
            </Card>
          )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
          {prayerTimes.map((prayer) => {
            ...
            return (
              ...
              >
                <CardContent className="p-3 flex flex-col items-center backdrop-blur-sm bg-background/30">
                  <span className="text-lg font-medium">{prayer.indonesianName}</span>
                  <span className="text-xs text-muted-foreground mb-1">{prayer.arabicName}</span>
        ...
        {/* 5. Keterangan lain */}
        <div className="p-4 bg-card rounded-lg shadow-md" dangerouslySetInnerHTML={{ __html: customText }} />
      </div>
