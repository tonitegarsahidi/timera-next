  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-6xl font-bold text-emerald-900 mb-4">
                <span className="text-emerald-600">Timera</span> - Jadwal Sholat Digital
              </h1>
              <p className="text-lg md:text-xl text-gray-700 mb-8">
                Solusi gratis dan mudah untuk menampilkan jadwal sholat, timer iqomah, dan informasi masjid di layar TV
                Anda.
              </p>
              ...
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <p className="text-sm md:text-base">Tampilan jadwal sholat yang informatif dan menarik</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Timera menyediakan semua yang Anda butuhkan untuk menampilkan jadwal sholat digital di masjid Anda
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-emerald-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Cara Penggunaan</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Buka Timera di browser TV Android atau perangkat yang terhubung ke TV</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Sesuaikan lokasi, waktu iqomah, dan tampilan sesuai kebutuhan masjid Anda</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Biarkan aplikasi berjalan di TV masjid Anda untuk menampilkan jadwal sholat
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Kompatibel dengan Berbagai Perangkat</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Timera dapat dijalankan di berbagai perangkat yang terhubung ke TV masjid Anda
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-emerald-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Keunggulan Timera</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">Mengapa memilih Timera untuk masjid Anda?</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Tidak ada biaya berlangganan atau pembelian. Timera sepenuhnya gratis untuk digunakan.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Antarmuka yang sederhana dan intuitif, tidak memerlukan keahlian teknis khusus untuk
                  mengoperasikannya.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              <CheckCircle2 className="h-6 w-6 text-emerald-600 mt-1 mr-3 flex-shrink-0" />
              <div>
                <h3 className="text-lg font-bold mb-1">Tidak Perlu Instalasi</h3>
                <p className="text-gray-600">
                  Cukup buka browser dan akses Timera. Tidak perlu menginstal aplikasi tambahan.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Desain yang elegan dan profesional untuk meningkatkan estetika masjid Anda.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-emerald-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Mulai Gunakan Timera Sekarang</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Tingkatkan pengalaman jamaah dengan jadwal sholat digital yang informatif dan menarik
          </p>
          <Link href="/app">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Timera. Semua hak dilindungi.</p>
          </div>
        </div>
      </footer>
    </div>
